...
public class RadialSelection : MonoBehaviour
{
    ...
    void ConfirmSelection()
    {
        if (currentSelectedRadialPart >= 0 &&
            currentSelectedRadialPart < sceneNames.Length &&
            !string.IsNullOrEmpty(sceneNames[currentSelectedRadialPart]))
        {
            UnityEngine.SceneManagement.SceneManager.LoadScene(sceneNames[currentSelectedRadialPart]);
        }
    }
